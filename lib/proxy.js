...
var http = require('http'),
  ...
  httpOptions = {
    ...
    router: {
      ...
      "client.istilllovecalligraphy.com": "127.0.0.1:9300",
      "local.istilllovecalligraphy.com": "127.0.0.1:8080",
      "melissaesplin.com": "127.0.0.1:8080",
      "www.melissaesplin.com": "127.0.0.1:8080",
      "m.melissaesplin.com": "127.0.0.1:8080",
      "dev.melissaesplin.com": "127.0.0.1:8080",
      "devwp.quiver.is": "127.0.0.1:8080",
      "wp.quiver.is": "127.0.0.1:8080",
      "192.168.1.5": "127.0.0.1:8080"
    }
  },
  notHttps = ['local.istilllovecalligraphy.com', 'devwp.quiver.is', 'wp.quiver.is'];


httpProxy.createServer(function (req, res, next) {
  if(!req.headers.host || !req.headers.host.match(REGEX_QUIVER) || !!~notHttps.indexOf(req.headers.host)) {
    next();
  } else {
    res.writeHead(302, {
...
var conf = require('./../config/convict.js'), 
  ...
  options = {
    ...
    router: {
     ...
     "client.quiver.is": "127.0.0.1:9300",
     "192.168.1.5": "127.0.0.1:8080",
     "calligraphy.quiver.is": "127.0.0.1:8080",
     "client.quiver.is": "127.0.0.1:9300",
     "diagnostic.quiver.is": "127.0.0.1:8080",
     "devcalligraphy.quiver.is": "127.0.0.1:8080",
     "testcalligraphy.quiver.is": "127.0.0.1:8080"
